...
function FlightDetailsCard(props) {
  ...
  const determineAirline = (carrierId) => {
    const airlines = {
      ...
      852: { name: 'Royal Air Maroc', image: noAirlinePicture },
      1107: { name: 'GOL Linhas Aéreas', image: noAirlinePicture },
      1218: { name: 'Iberia', image: noAirlinePicture },
      1317: { name: 'Korean Air', image: noAirlinePicture },
      851:{name:"Alaska Airlines", image: noAirlinePicture},
